...
## V5.7.1
Reliability patch for the question engine: unbiased Fisher-Yates shuffling, per-mode session history, topic question previews, question attempt/accuracy tracking, and cache-busted data loading. Practice, Revision, and Mini Mock avoid the immediately previous question set when the pool is large enough.
