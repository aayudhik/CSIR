...
const visualFiles=['schrodinger-infinite-well.svg','schrodinger-psi-vs-psi-squared.svg','schrodinger-time-evolution.svg','schrodinger-tunneling.svg'];
...
const breakdown={
  ...
  visuals:Math.min(1,0.25+visualRendered/4),
